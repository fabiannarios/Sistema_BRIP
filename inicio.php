...
<head>
    ...
    <body>
        ...
        <div class="container-logo">
                            ...
                            <h1 class="logo"><a href="./inicio.php">Monitoreo de Incidencias</a></h1>
                        </div>
        ...
        <main class="main-content">
            ...
            <section class="container top-categories">
                ...
                <div class="card-category category-literatura">
                    <p>Aweboniaco</p>
                    <span>Ver más</span>
                </div>
                <div class="card-category category-consulta">
                    <p>Urea</p>
                    <span>Ver más</span>
                </div>
                <div class="card-category category-ilustrado">
                    <p>Fertilizantes</p>
                    <span>Ver más</span>
                </div>
                <div class="card-category category-ilustrado">
